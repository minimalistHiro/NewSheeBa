...
extension QRCodeScannerView {
    ...
    public class QRScannerViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, AVCaptureMetadataOutputObjectsDelegate, UIAdaptivePresentationControllerDelegate {
        ...
        public init(showViewfinder: Bool = false, parentView: QRCodeScannerView) {
...
@available(macCatalyst 14.0, *)
extension QRCodeScannerView.QRScannerViewController: AVCapturePhotoCaptureDelegate {
...
public extension AVCaptureDevice {
    ...
    static var bestForVideo: AVCaptureDevice? {
        let deviceHasUltraWideCamera = !AVCaptureDevice.DiscoverySession(deviceTypes: [.builtInWideAngleCamera], mediaType: .video, position: .back).devices.isEmpty
